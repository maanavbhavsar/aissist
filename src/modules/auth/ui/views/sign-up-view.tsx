                    ...
                    <div className="bg-white px-4 sm:px-5 md:px-6 py-4 sm:py-5 md:py-5 flex justify-center overflow-y-auto">
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-2.5 md:gap-3">
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            ...
                                            <FormLabel className="text-gray-800">Name</FormLabel>
                                                <FormControl>
                                                <Input type="text" placeholder="John Doe" className="bg-gray-100 border-gray-300" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            ...
                                            <FormLabel className="text-gray-800">Confirm Password</FormLabel>
                                                <FormControl>
                                                <Input type="password" placeholder="re-enter password" className="bg-gray-100 border-gray-300" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                            ...
                            <div className="text-center text-sm text-gray-600">
                                Already have an account? <Link href="/sign-in" className="text-cyan-400 underline-offset-4 hover:underline font-medium hover:text-cyan-300">Sign In</Link>
                            </div>
                        </form>
                        </Form>
                        </div>
